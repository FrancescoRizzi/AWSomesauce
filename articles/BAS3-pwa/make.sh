...
#
# SWADOMAINALIAS:
#		Domain Alias to be used for the CloudFront Distribution
#
# ============================================================
...
SWABUCKET="swa.site"
STACKNAME="SWAStack"
SWADOMAINALIAS="swa.domain.example"
...
printf "Domain Alias             : $SWADOMAINALIAS\n"
...
aws cloudformation deploy \
	...
	--parameter-overrides SWABucket=$SWABUCKET SWACloudFrontOAI=$OAIID SWADomainAlias=$SWADOMAINALIAS
...
if [ "${SWADOMAIN}" == "" ]; then
	...
	printf "\n"
	printf "You should be able to access the SWA Web App through:\n"
	printf "RECOMMENDED --->\thttps://$SWADOMAINALIAS/\t<--- RECOMMENDED\n"
	printf "\tor http://$SWADOMAINALIAS/\n"
	printf "\tor http://$SWADOMAIN/\n"
	printf "\tor https://$SWADOMAIN/\n"
fi;
